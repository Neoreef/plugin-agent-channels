...
export interface ChannelModule {
     ...
     */
    handleWebhook(ctx: PluginContext, input: PluginWebhookInput, companyId?: string): Promise<WebhookResult>;
    /**
     ...
     */
    onOAuthComplete?(ctx: PluginContext, serviceId: string, auth: ZohoAuthState, companyId?: string): Promise<void>;
}

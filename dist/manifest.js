...
const manifest = {
    ...
    description: "Connects Paperclip Agents to users through everyday messaging channels. The plugin uses agent configurations to expose routes to an agent harness, and streams the response back. Platforms supported: Zoho Cliq, Teams, Discord, Slack.",
    author: "Neoreef",
    ...
    instanceConfigSchema: {
        ...
        properties: {
            ...
            oauthCallbackUrl: {
                ...
                description: "Full URL for OAuth redirect (e.g. https://cortex.neoreef.com/paperclip/api/plugins/{pluginId}/routes/callback).",
            },
            paperclipApiBase: {
                type: "string",
                title: "Paperclip API Base URL",
                description: "Base URL the plugin uses to act on approvals (default http://127.0.0.1:3100). Must be on pluginHttpAllowedPrivateHosts.",
            },
            paperclipApiToken: {
                type: "string",
                title: "Paperclip Board API Token",
                description: "Board API token (pcp_board_…) used to approve/deny from Cliq. Without it, approval cards are notification-only.",
            },
        },
    },
    jobs: [
